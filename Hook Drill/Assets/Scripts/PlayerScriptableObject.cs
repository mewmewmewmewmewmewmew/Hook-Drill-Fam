...
public class PlayerScriptableObject : ScriptableObject
{
    ...
    [Tooltip("This is the speed of the player while he moves in the air")][Range(0f, 5f)] public float MovementSpeedInAir;
    ...
    [Header("CoolDown")]
    [Tooltip("This is the maximum time you can have the glider on")][Range(0f, 5f)] public float GliderTimeLimit;
    ...
    [Tooltip("gravity")][Range(0f, 10f)] public float Glidergravity;
